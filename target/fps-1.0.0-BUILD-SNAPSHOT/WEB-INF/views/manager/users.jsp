<%@page import="org.springframework.security.authentication.encoding.Md4PasswordEncoder"%>
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li><a href="${pageContext.request.contextPath}/manager/products/"><i class="lnr lnr-menu"></i> <span>Ürünler</span></a></li>              
						<li><a href="${context}"><i class="lnr lnr-menu"></i> <span>Üyeler</span></a></li>  
					</ul>
				<!--sidebar nav end-->
			</div>
		</div>
				...
				<div class="user-panel-top">  	
					<div class="profile_details_left">
						<ul class="nofitications-dropdown">
							...
							<li><button id="myBtn" class="btn-info btn">Yeni Üye</button></li>
							<div class="clearfix"></div>	
						</ul>
					</div>
